...
// Helper classes for WebGL geometry, shaders, and utilities (Face, Vertex, Geometry,

// IcosahedronGeometry, DiscGeometry, createShader, createProgram, makeVertexArray,

// resizeCanvasToDisplaySize, makeBuffer, createAndSetupTexture, ArcballControl)

// Omitted for brevity, assumed unchanged and functional
...
class InfiniteGridMenu {
    ...
    private init(onInit?: InitCallback): void {
        ...
        const gl = this.canvas.getContext('webgl2', {
            ...
            // 🟢 FIX 1: Set alpha to true for transparency
        ...
        // 🟢 FIX 2: Clear color to transparent black (0, 0, 0, 0)
    ...
    private render(): void {
        ...
        gl.clearColor(0, 0, 0, 0); // Already set in init, but re-checked here
...
const defaultItems: MenuItem[] = [

    {
        ...
        image: 'https://via.placeholder.com/512/00ffff/000000?text=Placeholder',
...
export default InfiniteMenu;  // In src/App.tsx
